...
int	main() {
	...
	}
	{
		...
		std::cout << "Idea: " << a->getBrain()->getIdea(0) <<std::endl;
		std::cout << "Idea: " << a->getBrain()->getIdea(1) <<std::endl;
		std::cout << "Idea: " << a->getBrain()->getIdea(2) <<std::endl;
		std::cout << "\e[1;35m===========Testing Deep Copy===========\033[0m" << std::endl;
		Dog b(*a);
		std::cout << "Idea: " << b.getBrain()->getIdea(0) <<std::endl;
		std::cout << "Idea: " << b.getBrain()->getIdea(1) <<std::endl;
		std::cout << "Idea: " << b.getBrain()->getIdea(2) <<std::endl;
		a->getBrain()->setIdea(3, "sou um gatinho");
		b.getBrain()->setIdea(3, "sou um caozinho");
		std::cout << "Idea: " << b.getBrain()->getIdea(3) <<std::endl;
		std::cout << "Idea: " << a->getBrain()->getIdea(3) <<std::endl;
		std::cout << "\e[1;35m===========Destructing===========\033[0m" << std::endl;
		delete a;
	}
	Dog basic;
	...
	{
		Dog tmp = basic;
		std::cout << "Idea tmp: " << tmp.getBrain()->getIdea(0) <<std::endl;
		tmp.getBrain()->setIdea(1, "adeus");
		std::cout << "Idea Basic: " << basic.getBrain()->getIdea(1) <<std::endl;
	}
} 